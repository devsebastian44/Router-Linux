...
# 5. Filtrado de Archivos (Lo que NO va a GitHub - DevSecOps Sanitization)
...
# - scripts/: Herramientas de automatización privada (incluyendo este script).
# - .gitlab-ci.yml: Lógica de CI interna de GitLab.
...
# 6. Commit de Lanzamiento y Push a GitHub (Portafolio Público)
...
# 7. Retorno Seguro al Entorno de Trabajo (GitLab)
